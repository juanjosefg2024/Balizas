...
# Valores ejemplo RSSI del nodo.
    ...
    plt.scatter(escenario['x'], escenario['y'], color='green')
    for i in range(num_puntos): # Puntos del footprint
        xi,yi = trilateracion_2d(rssi[i],escenario) # Trilateración respecto a los puntos vecinos
        plt.scatter(xi, yi,color='blue') # Posición estimada
        print(xi,yi)
